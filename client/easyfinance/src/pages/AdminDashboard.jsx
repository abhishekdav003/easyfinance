...
import { 
  Users, UserPlus, UserMinus, CreditCard, Wallet, DollarSign, 
    ...
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <div className="flex flex-1">
        ...
        <div className="w-64 bg-white shadow-md">
          ...
          <nav className="mt-6">
            <div 
              className={`flex items-center px-6 py-3 cursor-pointer ${activeView === 'dashboard' ? 'bg-blue-50 text-blue-600' : 'text-gray-600 hover:bg-gray-50'}`}
            ...
            <div 
              className={`flex items-center px-6 py-3 cursor-pointer ${activeView === 'clients' ? 'bg-blue-50 text-blue-600' : 'text-gray-600 hover:bg-gray-50'}`}
            ...
            <div 
              className={`flex items-center px-6 py-3 cursor-pointer ${activeView === 'agents' ? 'bg-blue-50 text-blue-600' : 'text-gray-600 hover:bg-gray-50'}`}
            ...
            <div 
              className={`flex items-center px-6 py-3 cursor-pointer ${activeView === 'loans' ? 'bg-blue-50 text-blue-600' : 'text-gray-600 hover:bg-gray-50'}`}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
                ...
                <div className="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                  <div className="flex items-center">
                    ...
                    <div className="ml-4">
                      <h3 className="text-gray-500 text-sm">Amount Recovered</h3>
                      <div className="flex items-baseline">
                        <p className="text-2xl font-bold text-gray-900">
                  ...
                  <div className="h-64">
                    <ResponsiveContainer width="100%" height="100%">
                      <LineChart data={loanTimeSeriesData}>
                        ...
                        <Tooltip formatter={(value) => `$${value.toLocaleString()}`} />
                        <Legend />
                        <Line type="monotone" dataKey="disbursed" stroke="#8884d8" activeDot={{ r: 8 }} />
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      ...
                      <tr>
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex items-center">
                            <div className="ml-4">
                              <div className="text-sm font-medium text-gray-900">Client A</div>
                            </div>
                          </div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
                      ...
                      <tr>
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex items-center">
                            <div className="ml-4">
                              <div className="text-sm font-medium text-gray-900">Client B</div>
                            </div>
                          </div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      {clients.map((client, index) => (
                        <tr key={client._id || index} className="hover:bg-gray-50">
                          <td className="px-6 py-4 whitespace-nowrap">
                            <div className="flex items-center">
                              <div className="flex-shrink-0 h-10 w-10">
                                {client.clientpic ? (
                                  <img className="h-10 w-10 rounded-full object-cover" src={client.clientpic} alt="" />
                                ) : (
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <div className="text-sm text-gray-900">{client.clientAddress}</div>
                          </td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <button className="text-blue-600 hover:text-blue-900 mr-3">View</button>
                            <button className="text-green-600 hover:text-green-900 mr-3">Add Loan</button>
                          ...
                          <tbody>
                            {filteredAgents.map((agent) => (
                              <tr key={agent._id} className="hover:bg-gray-50 transition-colors">
                                <td className="px-6 py-4 border-b border-gray-200">{agent.agentusername}</td>
                                <td className="px-6 py-4 border-b border-gray-200">{agent.fullname}</td>
                                <td className="px-6 py-4 border-b border-gray-200">{agent.email}</td>
                                <td className="px-6 py-4 border-b border-gray-200">{agent.fathername}</td>
...
<div className="p-6">
  ...
  <div className="bg-white p-6 rounded-lg shadow-sm">
    <p className="text-gray-500">Loan management functionality coming soon...</p>
  </div>
</div>
)}
</div>
