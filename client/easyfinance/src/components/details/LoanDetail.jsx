...
const LoanDetailsShow = ({ loanId, onBack }) => {
  ...
  if (error) {
    return (
      <div
        className="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative m-6"
        role="alert"
      >
    ...
    <div className="bg-white shadow-md rounded-lg p-6 max-w-4xl mx-auto">
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-gray-600 mt-1">Loan ID: {loan._id}</p>
        </div>
...
>
  <div className="flex items-center justify-between">
    <div>
      ...
      {loan.totalAmountLeft <= 0 ? "Completed" : "Ongoing"}
    </div>
    <div className="text-right">
      ...
      <div>
        ...
        {loan.totalAmountLeft?.toLocaleString() || 0}
      </div>
    </div>
  </div>
</div>
      ...
      {activeTab === "details" ? (
          ...
          <div className="bg-gray-50 p-4 rounded-md md:col-span-2">
            ...
            <div className="space-y-3">
              ...
              <div className="flex">
                ...
                <span className="text-gray-800">
                  {loan.createdByName} ({loan.createdBy?.role})
                </span>
              </div>
              <div className="flex">
                <span className="font-medium text-gray-600 w-32">
        ...
        <div className="bg-white">
          ...
          {emiHistoryLoading ? (
  <p className="text-gray-500">Loading EMI history...</p>
) : emiError ? (
  <p className="text-red-500">{emiError}</p>
) : emiHistory.length === 0 ? (
